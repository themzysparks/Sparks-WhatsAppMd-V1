let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `Sparks-WhatsappMd-V1 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VafS5v1FXUuaMIXjeB35\n\n ${Config.botname} *© Sparks*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `*SUPPORT Sparks Themzy*\n\n PALMPAY Bank: PALMPAY Limited\n\n OPay Account: 9130815781\n\n *Support The Developer*2\n\n ${Config.botname} *Sparks*`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*Sparks-WhatsappMd-V1 CURRENTLY ACTIVE!*";
