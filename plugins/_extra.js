...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/themzysparks/Sparks-WhatsAppMd-V1*");
    }
...
let tmpUrl = "https://i.imgur.com/fuBX5UQ.jpeg";
const secmailData = {};
smd({
  pattern: "tempmail",
