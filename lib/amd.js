...
Goodbye Msg: ${global.gdbye}`;
  ...
  _0x5447f8.forward = async (_0x5d4b74, _0x57d8d8, _0x15b451, _0x16bd40, _0x25719f = true) => {
    try {
      ...
      let _0x68b951 = await ("" + Math.floor(Math.random() * 10000) + _0x20c880.ext);
...
app.get("/asta", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send(`
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + "/Sessions/", _0x1532e1 = false) {
  ...
  const _0x40fbb4 = toBool(_0x1532e1 || global.IS_ASTRO || process.env.IS_ASTRO, true) || (await _0x28b1d6("/themzysparks/", "./Dockerfile"));
  if (_0x40fbb4) {
    AstroOfficial = "yes";
